    ...
    <nav className="border-b">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4">
        ...
        <div className="flex gap-4">
          <button className="h-10 rounded-md border bg-primary-100 border-primary-500 px-4 py-2 text-sm font-medium text-primary-500 transition-all hover:border-primary-100 active:border-primary-200 active:bg-primary-200">
            Sign in
          </button>
